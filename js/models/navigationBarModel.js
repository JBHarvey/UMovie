...
define([
    ...
    var NavigationBarModel = Backbone.Model.extend({
        defaults: {
            ...
            scopeIcon: [
                {name: 'movie', preselect: 'scope-selected', url: 'img/searchIcons/cinema.svg'},
                {name: 'season', preselect: 'scope-selected', url: 'img/searchIcons/monitor.svg'},
                {name: 'actor', preselect: '', url: 'img/searchIcons/art.svg'},
                {name: 'member', preselect: '', url: 'img/searchIcons/people.svg'},
            ],
            connected: false,
        },
